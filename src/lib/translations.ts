...
export const TR = {
  ...
  hero: {
    ...
    status: {
      eyebrow: { en: 'A clear beginning', th: 'ข้อมูลสำคัญก่อนตัดสินใจ' },
      headline: { en: 'A quieter way to come home.', th: 'พื้นที่สงบที่ออกแบบมาเพื่อกลับบ้าน' },
      statusLabel: { en: 'Status today', th: 'สถานะวันนี้' },
      statusValue: { en: 'Preparing for private viewings', th: 'กำลังเตรียมเปิดเข้าชม' },
      moveInLabel: { en: 'Move in', th: 'พร้อมเข้าอยู่' },
      moveInValue: { en: 'October 2026', th: 'ตุลาคม 2569' },
      priceLabel: { en: 'Opening rate', th: 'ราคาเริ่มต้น' },
      priceValue: { en: '6,900 THB / month', th: '6,900 บาท / เดือน' },
      petLabel: { en: 'Pets', th: 'สัตว์เลี้ยง' },
      petValue: { en: 'Small pets welcome throughout', th: 'เลี้ยงสัตว์ได้ทั้งตึก' },
      availability: { en: 'Current availability is shared on LINE.', th: 'เช็กห้องว่างล่าสุดได้ทาง LINE' },
      cta: { en: 'Request a private viewing', th: 'นัดชมสถานที่จริง' },
    },
  },
  about: {
