...
export const TR = {
  ...
  residences: {
    ...
    decisionPriceLabel: { en: 'Starting rent', th: 'ค่าเช่าเริ่มต้น' },
    decisionPriceDetail: { en: 'Opening rate; floor-specific availability is confirmed on LINE.', th: 'ราคาเปิดตัว และยืนยันห้องว่างแต่ละชั้นทาง LINE' },
    decisionSizeLabel: { en: 'Room size', th: 'ขนาดห้อง' },
    decisionSizeDetail: { en: 'One bedroom, one bathroom, kitchenette and private balcony.', th: '1 ห้องนอน 1 ห้องน้ำ มุมครัว และระเบียงส่วนตัว' },
    ...
    decisionMoveinDetail: { en: 'Opening from October 2026.', th: 'เปิดให้เข้าอยู่ตุลาคม 2569' },
    decisionIncludedLabel: { en: 'Monthly rate', th: 'ค่าเช่ารายเดือน' },
    decisionIncludedDetail: { en: 'Wi-Fi, cleaning, A/C service and common amenities are included.', th: 'รวม Wi-Fi ทำความสะอาด ล้างแอร์ และสิ่งอำนวยความสะดวกส่วนกลาง' },
    decisionCostNote: {
      en: 'Move-in costs include a deposit, advance rent, security deposit and booking fee. Exact amounts, current room availability and viewing times are confirmed on LINE.',
      th: 'ค่าใช้จ่ายวันเข้าอยู่มีค่ามัดจำ ค่าเช่าล่วงหน้า ค่าประกัน และค่าจอง ยอดจริง ห้องว่างล่าสุด และเวลานัดชม ยืนยันทาง LINE',
    },
