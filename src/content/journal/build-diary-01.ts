...
const article: Article = {
  ...
  blocks: [
    ...
    },
    {
      type: 'p',
      text: {
        th: 'เงื่อนไขทางการค้าทั้งหมดเคาะแล้ว ทุกยูนิตเลี้ยงสัตว์ได้ เริ่มต้นที่ 6,900 บาทต่อเดือนแบบรวมทุกอย่าง ไม่มีค่าธรรมเนียมแฝง ไม่มีราคาพิเศษสำหรับการเลี้ยงสัตว์ เพราะสัตว์เลี้ยงไม่เคยถูกมองเป็นข้อยกเว้นที่นี่ตั้งแต่แรก ค่าเช่ารวม Wi-Fi (AIS Fiber) บริการทำความสะอาด และดูแลแอร์ไว้แล้ว ตัวเลขเดียวครอบคลุมทั้งเดือน สัญญาเช่ามีระยะ 12 เดือน วางมัดจำ 1 เดือน บวกล่วงหน้าอีก 1 เดือน และค่าประกันครั้งเดียว 5,000 บาท (ค่าจอง ฿500 ที่วางไว้ตอนจอง หักคืนในยอดวันเข้าอยู่) ตัวเลขทั้งหมดข้างต้นพูดครั้งเดียวและตรงกันทุกที่ที่คุณจะพบเจอ — ส่วนราคาที่แท้จริงของแต่ละชั้น เราแจ้งให้เป็นการส่วนตัวเมื่อมีผู้สนใจ',
        en: 'The commercial terms are settled. Every residence is pet-friendly, from 6,900 THB a month, all-inclusive — no hidden fees, no premium attached to keeping an animal, because pets were never treated as an exception here. Rent already carries Wi-Fi (AIS Fiber), cleaning, and air-conditioning service, so one figure covers the month. The lease runs twelve months, against a deposit of one month plus one month in advance, and a one-time 5,000 THB security deposit — the 500 THB booking fee paid to reserve is credited back against the move-in total. Every number above is stated once, and it will match wherever you encounter it — the exact rate for each floor is shared privately, on request.',
      },
    },
    {
      type: 'p',
