...
const article: Article = {
  ...
  blocks: [
    ...
    },
    {
      type: 'p',
      text: {
        th: 'แต่ละยูนิตขนาด 25.2 ตร.ม. มีโซนนอน ห้องน้ำ ตู้เก็บของอเนกประสงค์ และระเบียงส่วนตัว — และสำหรับบ้านที่มีสัตว์เลี้ยง ความใส่ใจอยู่ในรายละเอียดเล็ก ๆ เหล่านี้: อาหารของคุณและของเขาเก็บไว้สูงหลังบานตู้บิลต์อินที่ปิดมิดชิด พ้นจากจมูกที่อยากรู้อยากเห็น ซิงก์ล้างจานพักอยู่ที่ระเบียงแทนที่จะอยู่ข้างเตียง ประตูห้องน้ำที่ปิดได้ให้ความเป็นส่วนตัวเมื่อต้องการ ส่วนระเบียงเป็นพื้นที่เปิดรับแดด — หากอยากให้น้องออกไปนั่งรับลมด้วยกัน แนะนำติดตาข่ายเสริมของคุณเองก่อน เพื่อความปลอดภัยของเขา',
