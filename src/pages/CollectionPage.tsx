            ...
            <div className="mt-6 flex flex-col items-start justify-between gap-4 rounded-xl border sec-border bg-pure-white/50 p-7 backdrop-blur-sm md:flex-row md:items-center">
              ...
              <div className="flex flex-none items-center gap-5">
                ...
                <a
                  ...
                  className="inline-block cursor-pointer rounded-full bg-sage-green px-7 py-3 font-sans text-xs uppercase tracking-[0.1em] text-pure-white transition-opacity duration-300 hover:opacity-85"
                >
                  {lb.ctaButton[lang]}
                </a>
              </div>
